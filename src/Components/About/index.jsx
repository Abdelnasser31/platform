  ...
  return (
    <div className={styles.banner}>
        ...
        <Typography variant="h6">
          ...
          At Syrian Success Story, we share the real experiences of Syrians, from those still in Syria and from others who are now living in all areas of the world.<br/>
